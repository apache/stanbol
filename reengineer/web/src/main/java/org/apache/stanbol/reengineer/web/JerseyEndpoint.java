...
public class JerseyEndpoint {
    ...
    public static final String STATIC_RESOURCES_CLASSPATH_PROPERTY = "org.apache.stanbol.reengineer.web.jersey.static.classpath";

    @Property(value = "/META-INF/templates")
    public static final String FREEMARKER_TEMPLATE_CLASSPATH_PROPERTY = "org.apache.stanbol.reengineer.web.jersey.templates.classpath";
