...
public class OntologyStorage {
    ...
    protected void activate(ComponentContext context) {
        log.info("in " + OntologyStorage.class + " activate with context " + context);
        if (context == null) {
    ...
    protected void deactivate(ComponentContext context) {
        log.info("in " + OntologyStorage.class + " deactivate with context " + context);
        tcManager = null;
    ...
    public void store(OWLOntology o) {
        ...
        MGraph mg2 = tcManager.createMGraph(new UriRef(o.getOntologyID().getOntologyIRI().toString()));
        mg2.addAll(mg);
    }
