...
import eu.iksproject.rick.core.utils.ToStringIterator;
 ...
 * Specific implementations of the RICK models might want to use this implementation
...
public class DefaultSymbolImpl extends DefaultSignImpl implements Symbol {
	 ...
	 * @param rickId the ID of the Rick that manages this Symbol
	 ...
	 * This includes: <ul>
	 * <li> the Rick ID is <code>null</code> or empty
	 ...
	 * </ul>
	 */
	public DefaultSymbolImpl(String siteId,Representation representation){
		this(siteId,representation,null);
	}
	/**
	 ...
	 * </ul>
	 */
	public DefaultSymbolImpl(String rickId,Representation representation,String defaultLanguage) throws IllegalArgumentException {
		super(rickId,representation);
		if(getLabel() == null){
