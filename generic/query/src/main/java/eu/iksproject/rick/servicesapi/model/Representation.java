...
public interface Representation {
    public static enum RepresentationTypeEnum {
        /**
         * A Representation for an Entity
         */
        Entity(RdfResourceEnum.Entity.getUri()),
        /**
         *  A Representation for an Symbol
         */
        Symbol(RdfResourceEnum.Symbol.getUri()),
        /**
         * A Representation for a EntityMapping
         */
        EntityMapping(RdfResourceEnum.EntityMapping.getUri()),
        ;
        private String uri;
        RepresentationTypeEnum(String uri){
    ...
    String getId();
    /**
     * Getter for the type of a representation
     * @return the type
     */
    RepresentationTypeEnum getType();
    /**
