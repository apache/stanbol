...
public abstract class ValueFactoryTest {
     ...
     * @return the {@link ValueFactory} for the Entityhub model implementation 
     * to be tested
     */
     ...
     * Based on that Entityhub allows implementations to convert an empty 
     * language to <code>null</code> but does NOT allow to to convert 
     * <code>null</code> to an empty string.<p>
