 ...
 * <li>the <b>organisation</b> (Site) that acts as origin of the Sign
 * </ol>
...
public interface Sign {
    /**
     * Enumeration over the different types of Signs defined by the RICK
     * @author Rupert Westenthaler
     *
     */
    public static enum SignTypeEnum {
        ...
        /**
         *  Symbols are Signs defined by this Rick instance
         */
     ...
     * Note that the Rick allows that different referenced Sites
     ...
     * Note also, that the RICK assumes that all such representations
