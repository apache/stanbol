package eu.iksproject.fise.jersey.writers;
...
public class JsonLdSerializerProviderTest {
	...
	@Before
	public void setup() {
		this.jsonldProvider = new JsonLdSerializerProvider();
	}
	...
	private void getTextAnnotation(ContentItem ci, String annotationURNExtension, String namedEntity, String context, UriRef type) {
		...
		TextAnnotation testAnnotation = factory.getProxy(new UriRef("urn:iks-project:fise:test:text-annotation:" + annotationURNExtension), TextAnnotation.class);
