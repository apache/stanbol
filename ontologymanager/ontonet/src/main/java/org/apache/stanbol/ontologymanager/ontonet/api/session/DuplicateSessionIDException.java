...
/**
 * Thrown when attempting to create a KReSSession by forcing a session ID that is already registered, even if
 * it used to be associated to a session that has been destroyed.
 * 
 * @author alexdma
 * 
 */
