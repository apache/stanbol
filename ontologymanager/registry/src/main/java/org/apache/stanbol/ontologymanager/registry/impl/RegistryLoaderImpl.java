...
import org.apache.stanbol.ontologymanager.registry.impl.cache.ODPRegistryCacheException;
import org.apache.stanbol.ontologymanager.registry.impl.cache.ODPRegistryCacheManager;
import org.apache.stanbol.ontologymanager.registry.impl.cache.URIUnresolvableException;
import org.apache.stanbol.ontologymanager.registry.impl.model.AbstractRegistryItem;
...
import org.apache.stanbol.ontologymanager.registry.xd.util.RDFSLabelGetter;
...
public class RegistryLoaderImpl implements RegistryLoader {
    ...
    /**
	 */
    public RegistryLoaderImpl(RegistryManager regmgr, ONManager onm) {
        this.regmgr = regmgr;
        this.onm = onm;
    }
    ...
    public Registry loadLibrary(IRI registryPhysicalIRI, IRI libraryID) {
        ...
        try {
            ...
            registry = regmgr.createModel(Collections.singleton(ontology)).iterator().next();
