...
@Component(
        ...
        factory="eu.iksproject.rick.site.SparqlDereferencerFactory",
...
public class SparqlDereferencer extends AbstractEntityDereferencer {
     ...
     */
    public static final String SPARQL_ENDPOINT_URI = "eu.iksproject.rick.servicesapi.site.sparqlEndpointUri";
