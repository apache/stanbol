 ...
 * Each {@code RDFBridgeConfiguration} indicates a set of target resource in the RDF data. Resources filtered
 * based on the configuration of the bridge are created as nodes/object in the repository. This interface also
 * aims to get configuration values for properties and names of objects to be created in the repository.
 * 
 * @author suat
 * 
 */
public interface RDFBridgeConfiguration {
    /**
