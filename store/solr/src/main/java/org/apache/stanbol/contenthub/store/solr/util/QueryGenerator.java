...
public class QueryGenerator {
    ...
    public static final String getFieldQuery(SolrFieldName fieldName) {
        switch (fieldName) {
            ...
            case FIELDS:
                return getFields();
            default:
                logger.error("No SPARQL query for the fieldName: {}", fieldName.toString());
                return null;
        }
    }
    ...
    public static final String getPlaceEntities() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       ...
                       + SolrFieldName.PLACES.toString() + " WHERE { \n"
                       ...
                       + " ?enhancement fise:entity-label ?" + SolrFieldName.PLACES.toString() + ".\n"
                       + "}\n";
        return query;
    }
    ...
    public static final String getPersonEntities() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       + "PREFIX dc: <http://purl.org/dc/terms/>\n" + "SELECT DISTINCT ?"
                       + SolrFieldName.PEOPLE.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
                       + " ?enhancement fise:entity-type <http://dbpedia.org/ontology/Person>.\n"
                       + " ?enhancement fise:entity-label ?" + SolrFieldName.PEOPLE.toString() + ".\n"
                       + "}\n";
        return query;
    }
    ...
    public static final String getOrganizationEntities() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       + "PREFIX dc: <http://purl.org/dc/terms/>\n" + "SELECT DISTINCT ?"
                       + SolrFieldName.ORGANIZATIONS.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
                       + " ?enhancement fise:entity-type <http://dbpedia.org/ontology/Organisation>.\n"
                       + " ?enhancement fise:entity-label ?" + SolrFieldName.ORGANIZATIONS.toString() + ".\n"
                       + "}\n";
        return query;
    }
    ...
    private static final String getCountries() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       ...
                       + SolrFieldName.COUNTRIES.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
    ...
    private static final String getImageCaptions() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       ...
                       + SolrFieldName.IMAGECAPTIONS.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
    ...
    private static final String getRegions() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       + "PREFIX dc: <http://purl.org/dc/terms/>\n"
                       + "PREFIX dbprop: <http://dbpedia.org/property/>\n" + "SELECT DISTINCT ?"
                       + SolrFieldName.REGIONS.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
                       + " ?enhancement fise:entity-reference ?entity.\n" + " ?entity dbprop:region ?"
                       + SolrFieldName.REGIONS.toString() + ".\n" + "}\n";
        return query;
    }
    ...
    private static final String getGovernors() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       + "PREFIX dc: <http://purl.org/dc/terms/>\n"
                       + "PREFIX dbprop: <http://dbpedia.org/property/>\n" + "SELECT DISTINCT ?"
                       + SolrFieldName.GOVERNORS.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
    ...
    private static final String getCapitals() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       + "PREFIX dc: <http://purl.org/dc/terms/>\n"
                       + "PREFIX dbprop: <http://dbpedia.org/property/>\n" + "SELECT DISTINCT ?"
                       + SolrFieldName.CAPITALS.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
    ...
    private static final String getLargestCities() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       + "PREFIX dc: <http://purl.org/dc/terms/>\n"
                       + "PREFIX dbprop: <http://dbpedia.org/property/>\n" + "SELECT DISTINCT ?"
                       + SolrFieldName.LARGESTCITIES.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
    ...
    private static final String getLeaderNames() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       + "PREFIX dc: <http://purl.org/dc/terms/>\n"
                       + "PREFIX dbprop: <http://dbpedia.org/property/>\n" + "SELECT DISTINCT ?"
                       + SolrFieldName.LEADERNAMES.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
    ...
    private static final String getGivenNames() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       ...
                       + SolrFieldName.GIVENNAMES.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
    ...
    private static final String getKnownFors() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       + "PREFIX dc: <http://purl.org/dc/terms/>\n"
                       + "PREFIX dbprop: <http://dbpedia.org/property/>\n" + "SELECT DISTINCT ?"
                       + SolrFieldName.KNOWNFORS.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
    ...
    private static final String getBirthPlaces() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       + "PREFIX dc: <http://purl.org/dc/terms/>\n"
                       + "PREFIX dbont: <http://dbpedia.org/ontology/>\n" + "SELECT DISTINCT ?"
                       + SolrFieldName.BIRTHPLACES.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
    ...
    private static final String getPlacesOfBirths() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       + "PREFIX dc: <http://purl.org/dc/terms/>\n"
                       + "PREFIX dbprop: <http://dbpedia.org/property/>\n" + "SELECT DISTINCT ?"
                       + SolrFieldName.PLACEOFBIRTHS.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
    ...
    private static final String getWorkInstitutions() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       ...
                       + " ?textEnh a fise:TextAnnotation.\n"
                       + " ?enhancement fise:entity-reference ?entity.\n"
                       + " ?entity dbprop:workInstitutions ?" + SolrFieldName.WORKINSTITUTIONS.toString()
                       + ".\n" + "}\n";
        return query;
    }
    ...
    private static final String getCaptions() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       + "PREFIX dc: <http://purl.org/dc/terms/>\n"
                       + "PREFIX dbprop: <http://dbpedia.org/property/>\n" + "SELECT DISTINCT ?"
                       + SolrFieldName.CAPTIONS.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
    ...
    private static final String getShortDescriptions() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       ...
                       + " ?textEnh a fise:TextAnnotation.\n"
                       + " ?enhancement fise:entity-reference ?entity.\n"
                       + " ?entity dbprop:shortDescription ?" + SolrFieldName.SHORTDESCRIPTIONS.toString()
                       + ".\n" + "}\n";
        return query;
    }
    ...
    private static final String getFields() {
        String query = "PREFIX fise: <http://fise.iks-project.eu/ontology/>\n"
                       + "PREFIX dc: <http://purl.org/dc/terms/>\n"
                       + "PREFIX dbont: <http://dbpedia.org/ontology/>\n" + "SELECT DISTINCT ?"
                       + SolrFieldName.FIELDS.toString() + " WHERE { \n"
                       + " ?enhancement a fise:EntityAnnotation.\n" + " ?enhancement dc:relation ?textEnh.\n"
                       + " ?textEnh a fise:TextAnnotation.\n"
                       + " ?enhancement fise:entity-reference ?entity.\n" + " ?entity dbont:field ?"
                       + SolrFieldName.FIELDS.toString() + ".\n" + "}\n";
        return query;
    }
    ...
    /*
     * public static final String getRecentlyEnhancedDocuments(int pageSize, int offset) { String query =
     * "PREFIX enhancer: <http://fise.iks-project.eu/ontology/> " +
     * "PREFIX dc:   <http://purl.org/dc/terms/> " + "SELECT DISTINCT ?content WHERE { " +
     * "  ?enhancement enhancer:extracted-from ?content ." + "  ?enhancement dc:created ?extraction_time . } "
     * + "ORDER BY DESC(?extraction_time) LIMIT %d OFFSET %d"; return String.format(query, pageSize, offset);
     * }
     */
}
