...
import java.lang.Integer; //to ensure the class is found while processing annotations
...
public class MainLabelTokenizer implements LabelTokenizerManager, LabelTokenizer {
    ...
    /* (non-Javadoc)
     * @see org.apache.stanbol.enhancer.engines.keywordextraction.impl.LabelTokenizerManager#getService(org.osgi.framework.ServiceReference)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.stanbol.enhancer.engines.keywordextraction.impl.LabelTokenizerManager#getTokenizers(java.lang.String)
     */
    @Override
