...
public class ProcessingState {
    ...
    protected final TextProcessingConfig tpc;
...
//    }
     ...
     * <li> {@link TextProcessingConfig#getMinPosAnnotationProbability()} for accepting POS tags that are
     * processed - included in {@link TextProcessingConfig#getLinkedLexicalCategories()} or
     * {@link TextProcessingConfig#getLinkedPosTags()}.
     * <li> {@link TextProcessingConfig#getMinExcludePosAnnotationProbability()} for those that are not
