...
public class DefaultEntityMappingImpl extends DefaultSignImpl implements EntityMapping {
	 ...
	 * @param rickId The ID of the Rick that defines this mapping
	 ...
	 *       to the requirements
	 */
	public DefaultEntityMappingImpl(String rickId, String symbol,String entity,MappingState state,Representation representation) throws IllegalArgumentException {
