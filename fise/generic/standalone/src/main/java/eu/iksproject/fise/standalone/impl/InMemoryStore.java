package eu.iksproject.fise.standalone.impl;
...
/** Trivial in-memory Store for standalone FISE server */
...
public class InMemoryStore implements Store {
    ...
    @Property(value = "http://fise.iks-project.eu/graphs/enhancements")
    public static final String GRAPH_URI = "eu.iksproject.fise.standalone.store.graphUri";
