package eu.iksproject.fise.sace;
...
import eu.iksproject.fise.sace.ui.SaceGUI;
...
import eu.iksproject.fise.sace.util.Util;
...
public class Sace {
    ...
    public static final String WINDOW_TITLE = "FISE - S.A.C.E";
    ...
    static String getServerUrl() {
        final String result = (String) JOptionPane.showInputDialog(null,
                "Please indicate the FISE server URL", WINDOW_TITLE,
    ...
    public List<IAnnotation> annotateTextWithFISE(final String text) {
        // get stuff from FISE
        String result = sendTextToFISE(text);
        System.out.println(result);
        // transform FISE-annotations to SACE-annotations
        return transformRDFXMLToAnnotations(result);

    }

    public String sendTextToFISE(String text) {
        try {
                ...
                for (Object o2 : node.getChildren()) {
                    ...
                    if (sName.equals("creator")
                        ...
                        textAnnot.setCreated(created);
                            ...
                            && sNs
                                    .equals("http://fise.iks-project.eu/ontology/")) {
    ...
    public void submitTextAnnotationToFISE(TextAnnotation ta) {
        // TODO!
    }

    public void submitEntityAnnotationToFISE(EntityAnnotation ea) {
        // TODO!
    }

    public void submitDocumentAnnotationToFISE(DocumentAnnotation da) {
        // TODO!
    }

    public void submitImageAnnotationToFISE(ImageAnnotation ia) {
        // TODO!
    }
