 ...
 * <code>'.'+{@link IndexInstallerConstants#SOLR_INDEX_ARCHIVE_EXTENSION}</code>
 ...
 * activity instances of {@link IndexInstallTask} or {@link IndexRemoveTask} are
 * created.<p>
 ...
 * framework. If {@link #transform(RegisteredResource)} returns <code>null</code>
 * the Sling Installer framework will call the next registered 
 * {@link ResourceTransformer} instance. By returning a {@link TransformationResult}
...
@Property(name=Constants.SERVICE_RANKING,intValue=100) //we need to be in front of the Sling Components
public class SolrIndexInstaller implements InstallTaskFactory, ResourceTransformer{
    ...
    /**
     * This service manages the SolrIndex Directory of the SolrYard. It is needed
