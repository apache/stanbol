...
@Path("/ontologies/{ontologyPath:.+}/objectProperties/{objectPropertyPath:.+}")
@ImplicitProduces(MediaType.TEXT_HTML + ";qs=2.0")
public class ParticularObjectProperty {
    ...
    public Response update(@PathParam("ontologyPath") String ontologyPath,
                           ...
                           @FormParam("isSymmetric") Boolean isSymmetric,
                           @FormParam("isInverseFunctional") Boolean isInverseFunctional) {
        metadata = (ObjectPropertyContext) makeSubClassOf(ontologyPath, objectPropertyPath, /*
                                                                                             * domainURIs,
                                                                                             * rangeURIs,
                                                                                             * subPropertyOf,
                                                                                             */
        isFunctional, isTransitive, isSymmetric, isInverseFunctional).getEntity();
