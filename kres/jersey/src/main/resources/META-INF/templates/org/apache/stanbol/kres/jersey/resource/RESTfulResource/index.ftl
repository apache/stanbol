<p>A description of the RESTful services can be found <a href="/kres/documentation/restful" alt="RESTful">here</a></p>
...
<LI><A NAME="tex2html559"
  HREF="#SECTION000114100000000000000">/kres/ontology</A>
<UL>
...
<LI><A NAME="tex2html564"
  HREF="#SECTION000114200000000000000">/kres/session</A>
<UL>
...
<LI><A NAME="tex2html569"
  HREF="#SECTION000114300000000000000">/kres/rule</A>
<UL>
...
<LI><A NAME="tex2html573"
  HREF="#SECTION000114400000000000000">/kres/recipe</A>
<UL>
...
<LI><A NAME="tex2html577"
  HREF="#SECTION000114500000000000000">/kres/classify</A>
<LI><A NAME="tex2html578"
  HREF="#SECTION000114600000000000000">/kres/check-consistency</A>
<UL>
...
<LI><A NAME="tex2html581"
  HREF="#SECTION000114700000000000000">/kres/enrich</A>
<LI><A NAME="tex2html582"
  HREF="#SECTION000114800000000000000">/kres/refactor (/lazy and /consistent)</A>
<UL>
...
<LI><A NAME="tex2html585"
  HREF="#SECTION000114900000000000000">/kres/reengineer</A>
<UL>
...
<PRE>
 $ curl -X GET -H "Accept: text/turtle" \
     http://localhost:8080/kres/ontology

 $ curl -X GET -H "Accept: text/turtle" \
     http://localhost:8080/kres/ontology?with-inactive=true
</PRE>
...
<PRE>
 $ curl -X GET -H "Accept: text/turtle" \
     http://localhost:8080/kres/ontology/User
</PRE>
...
<PRE>
 $ curl -X GET -H "Accept: text/turtle" \
	http://localhost:8080/kres/ontology/User/http://xmlns.com/foaf/0.1/
</PRE>
...
<PRE>
 $ curl -X GET -H "Accept: text/turtle" \
http://localhost:8080/kres/ontology/get
...
<P>
<PRE>
 $ curl -X GET http://localhost:8080/kres/session/http://session-iri
</PRE>
...
<PRE>
 $ curl -X POST \
-F scope="http://localhost:8080/kres/ontology/User"
	http://localhost:8080/kres/session
</PRE>
...
-d scope="http://localhost:8080/kres/ontology/User"
	http://localhost:8080/kres/session
</PRE>
...
$ curl -X GET -H "Accept: application/rdf+xml" \ 
	http://localhost:8080/kres/rule/all
</PRE>
...
<PRE>
$ curl -X GET -H "Accept: application/rdf+xml" \
     http://localhost:8080/kres/rule/http://my-rule-iri
</PRE>
...
The <I>/kres/recipe</I> service provides recipe access, creation and deletion. 
...
GET</A>
</H4> requests returns the description of a recipe. With <I>/kres/recipe/all</I> it returns the list of all available recipes.
...
<PRE>
$ curl -X GET -H "Accept: application/rdf+xml" \ 
	http://localhost:8080/kres/recipe/all
</PRE>
...
<PRE>
$ curl -X GET -H "Accept: application/rdf+xml" \
     http://localhost:8080/kres/recipe/http://recipe-iri
</PRE>
...
$ curl -X POST \ 
 ...
 -F description
	http://localhost:8080/kres/recipe
</PRE>
...
$ curl -X POST -H "Accept: application/rdf+xml" \
 -F scope="http://localhost:8080/kres/ontology/http://scope-iri/MyScope" \
 -F recipe="http://localhost:8080/kres/recipe/http://recipe-iri/MyRecipe" \
 -F file=@/Users/enricodaga/foaf.rdf \
 	http://localhost:8080/kres/classify/
</PRE>
...
<PRE>
$ curl -X POST -H "Accept: application/rdf+xml" \
 -F session="http://localhost:8080/kres/ontology/User" \ 
 -F file=@/Users/enricodaga/foaf.rdf \	
...
<PRE>
$ curl -X [GET -H "Accept: text/turtle"] \ 
	http://localhost:8080/kres/classify/fileIri
</PRE>
...
$ curl -X POST -H "Accept: application/rdf+xml" H "Content-type: text/turtle" \
 ...
 -F recipe="http://localhost:8080/kres/recipe/http://recipe-iri/MyRecipe" \
 -F file=@/Users/enricodaga/foaf.rdf \
     http://localhost:8080/kres/check-consistency/
</PRE>
...
$ curl -X POST -H "Accept: application/rdf+xml" \
 ...
 -F session="http://kres.iks-project.eu/session/1283861908122" \
 -F recipe="http://localhost:8080/kres/recipe/http://recipe/SameWorkplaceGeneration" \
 -F input=@/Users/enricodaga/foaf.rdf \
     http://localhost:8080/kres/enrich/
</PRE>
...
<PRE>
$ curl -X POST -H "Accept: application/rdf+xml" \
 -F scope="http://localhost:8080/kres/ontology/MyScope" \
 -F recipe="http://localhost:8080/kres/recipe/http://recipe-iri/MyRecipe" \ 
...
/kres/refactor (/lazy and /consistent)</A>
</H3>
...
<OL>
<LI>the /kres/refactor/lazy applies refactoring without considering consistency check;
</LI>
<LI>the /kres/refactor/consistent applies refactoring considering consistency check;
</LI>
</OL>
...
<PRE>
$ curl -X GET -H "Accept: text/turtle" \
 -G -d recipe="http://localhost:8080/kres/recipe/myRecipe" \
 -d input-graph="http://torefactor/graph" \
 -d output-graph="http://torefactor/output-graph" \
     http://localhost:8080/kres/refactor/lazy
</PRE>
...
<PRE>
$ curl -X GET -H "Accept: text/turtle" \
 -G -d recipe="http://localhost:8080/kres/recipe/http://recipes/MyRecipe" \
 -d input-graph="http://torefactor/graph" \
 -d output-graph="http://refactored/output-graph" \
     http://localhost:8080/kres/refactor/consistent
</PRE>
...
$ curl -X POST -H "Accept: text/turtle" \
 -F recipe="http://localhost:8080/kres/recipe/toMyOntology" \
 -F input=@/Users/enricodaga/foaf.rdf \
     http://localhost:8080/kres/refactor/lazy
</PRE>
...
$ curl -X POST -H "Accept: text/turtle" \
 ...
 -F input=@/Users/enricodaga/profile.xml \
     http://localhost:8080/kres/reengineer/

$ curl -X POST -H "Accept: text/turtle" \
 -F recipe="http://localhost:8080/kres/recipe/xml2owl" \
 -F input=@/Users/enricodaga/profile.xml \
     http://localhost:8080/kres/reengineer/
</PRE>
...
$ curl -X POST -H "Accept: text/plain" \
 ...
 -F recipe="http://localhost:8080/kres/recipe/mydbschema2owl" \
     http://localhost:8080/kres/reengineer/dbsource
</PRE>
