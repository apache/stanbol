...
//                    "KReSRuleStore with stored rules and recipes is missing in ServletContext");
   ...
   /**
     * To run a classifying reasoner on a RDF input File or IRI on the base of a Scope (or an ontology) and a recipe. Can be used either HermiT or an owl-link server reasoner end-point
     * @param session {A string contains the session IRI used to classify the input.}
     * @param scope {A string contains either a specific scope's ontology or the scope IRI used to classify the input.}
    ...
    public Response ontologyClassify(@FormParam(value="session") String session,@FormParam(value="scope") String scope,@FormParam(value="recipe") String recipe,@FormParam(value="input-graph") String input_graph,@FormParam(value="file") File file,@FormParam(value="owllink-endpoint") String owllink_endpoint){
      ...
      if(owllink_endpoint==null){
       ...
       if(recipe!=null) {
            ...
            //Prepare and start the reasoner to classify ontology's resources
      ...
      try{
       if(recipe!=null) {
         ...
         //Create the reasoner for the consistency check by using the server and-point
