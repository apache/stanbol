...
public class KReSDOMParser
     ...
     */
    public KReSDOMParser(XMLParserConfiguration config) {
        super(config);
     ...
     */
    public KReSDOMParser(SymbolTable symbolTable) {
     ...
     * grammar pool.
     */
    public KReSDOMParser(SymbolTable symbolTable, XMLGrammarPool grammarPool) {
