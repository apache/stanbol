...
public class SemionRefactorerImpl implements SemionRefactorer {
     ...
     * <p>
     * DO NOT USE to manually create instances - the SemionRefactorerImpl instances do need to be configured!
     * YOU NEED TO USE
    ...
    protected void activate(ComponentContext context) throws IOException {
        log.info("in " + SemionRefactorerImpl.class + " activate with context " + context);
        if (context == null) {
     ...
     * 
     * for(KReSRule kReSRule : kReSRuleList){ String sparql = kReSRule.toSPARQL();
     * 
     ...
     * log.error("SemionRefactorer : No Such recipe in the KReS Rule Store", e1); throw e1; }
     * 
    ...
    @Override
    public void consistentOntologyRefactoring(IRI refactoredOntologyIRI, IRI datasetURI, IRI recipeIRI) throws SemionRefactoringException,
         ...
         * 
         * for(IRI ruleIRI : ruleIRIs){ KReSRule kReSRule = kReSRuleManager.getRule(ruleIRI);
         * 
         * String sparql = kReSRule.toSPARQL();
         * 
    ...
    @Override
    public OWLOntology consistentOntologyRefactoring(OWLOntology inputOntology, IRI recipeIRI) throws SemionRefactoringException,
                                                                                              NoSuchRecipeException,
                                                                                              InconcistencyException {
    ...
    protected void deactivate(ComponentContext context) {
        log.info("in " + SemionRefactorerImpl.class + " deactivate with context " + context);
    ...
    @Override
    public void ontologyRefactoring(IRI refactoredOntologyIRI, IRI datasetURI, IRI recipeIRI) throws SemionRefactoringException,
                                                                                             NoSuchRecipeException {
    ...
    @Override
    public OWLOntology ontologyRefactoring(OWLOntology inputOntology, IRI recipeIRI) throws SemionRefactoringException,
                                                                                    NoSuchRecipeException {
        OWLOntology refactoredOntology = null;
