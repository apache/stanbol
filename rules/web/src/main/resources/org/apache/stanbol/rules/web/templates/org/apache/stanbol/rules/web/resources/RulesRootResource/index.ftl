...
<input id="show-sytanx-button" value="show" type="button" onClick="javascript:var interaction = new Interaction(); interaction.show();">
<input id="hide-sytanx-button" value="hide" type="button" onClick="javascript:var interaction = new Interaction(); interaction.hide();">
<div id="syntax-body">
<H3>TOKENS</H2> 
<TABLE> 
 <!-- Token --> 
