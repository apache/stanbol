...
public class TokenMgrError extends Error {
     ...
     * error. Parameters : EOFSeen : indicates if EOF caused the lexical error curLexState : lexical state in
     * which this error occurred errorLine : line number when the error occurred errorColumn : column number
     * when the error occurred errorAfter : prefix that was seen before this error occurred curchar : the
