...
/**
 * Interface to store and retrieve Items instances persistently. This extends the {@link IndexingSource}
...
public interface Store<Item> extends IndexingSource<Item> {
    ...
    /**
     * Stores supplied item and return its uri, which is assigned by the store if not defined yet.
     * <p>
     * 
    ...
    /**
     * Stores all supplied items and returns it uris, which is assigned by the store if not defined yet.
     * <p>
     * If an Item already exists it is replaced with the parsed version.
     * 
     * @param item
     ...
     * <p>
     * <i>NOTE:</i> This method does NOT return the removed Items to avoid loading a lot of data when deleting
     * a big about of Items. Users that do need the data for removed Items should use {@link #remove(String)}
     * instead.
     * 
     * @param uris
