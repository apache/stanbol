...
public enum ZemantaPropertyEnum {
	...
	ZemantaPropertyEnum(boolean required, String defaultValue, String...valueList){
		...
		if(valueList != null && valueList.length>0){
			this.valueList = Collections.unmodifiableSet(
					new HashSet<String>(Arrays.asList(valueList)));
		}
	...
	public boolean hasValueList() { return valueList != null; }
	...
	public Set<String> getValueList() { return valueList; }
