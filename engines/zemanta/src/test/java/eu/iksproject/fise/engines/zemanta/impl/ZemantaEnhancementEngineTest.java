...
public class ZemantaEnhancementEngineTest {
    ...
    public static void setUpServices() throws IOException {
        ...
        properties.put(ZemantaEnhancementEngine.API_KEY_PROPERTY, ZEMANTA_FISE_TEST_APPLICATION_KEY);
    ...
    public static ContentItem wrapAsContentItem(final String text) {
        return new ContentItem() {
            ...
            String id = "urn:eu.iksproject.fise:test:engines.zemanta:content-item-"+EnhancementEngineHelper.randomUUID().toString();
