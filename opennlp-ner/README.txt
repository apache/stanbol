...
- From the Karaf web console, set the property "eu.iksproject.fise.engines.opennlp.models.path"
...
- Watch the console when you add text using commands such as:
  ...
  curl -T myText.txt -H Content-Type:text/plain http://localhost:8181/fise/someId
