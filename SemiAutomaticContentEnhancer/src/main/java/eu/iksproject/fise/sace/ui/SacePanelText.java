...
public class SacePanelText extends JPanel {
                    ...
                    if (!alreadyThere) {
                        ...
                        mi.addActionListener(new ActionListener() {
                            public void actionPerformed(ActionEvent e) {
                                ...
                                submitAnnotationToFISE(annotation);
                            }
                        });
                        pm.add(mi);
                    }
    ...
    private void submitAnnotationToFISE(TextAnnotation ta) {
        saceGUI.submitTextAnnotationToFISE(ta);
    }
