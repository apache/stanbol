...
public class OWLAPIToClerezzaConverterTest {
	...
	public static void setupClass(){
		 ...
		 *  AndreaNuzzolese knows EnricoDaga  -> object property assertion axiom
		 */
		...
		if(ontology != null){
			...
			OWLNamedIndividual andreaNuzzoleseOWL = factory.getOWLNamedIndividual(IRI.create(ns+"AndreaNuzzolese"));
	...
	public void testMGraphToOWLOntology(){
		 ...
		 */
		OWLOntology ontology = OWLAPIToClerezzaConverter.clerezzaMGraphToOWLOntology(mGraph);
